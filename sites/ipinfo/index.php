...
<div>
      <div class="container">
        <header class="d-flex justify-content-center py-3">
            <ul class="nav nav-pills">
                <li class="nav-item"><a href="https://anditv.dev/" class="nav-link nav-link-new" aria-current="page">Home</a></li>
                <li class="nav-item"><a href="https://anditv.dev/short/" class="nav-link nav-link-new">URL-Shortener</a></li>
                <li class="nav-item"><a href="https://anditv.dev/sites/ipinfo/" class="nav-link active">IP-Info</a></li>
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle nav-link-new" href="#" id="dropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> More </a>
                    <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                        <li><a class="dropdown-item nav-link-new" href="https://anditv.dev/sites/webhookdeleter/">Discord Webhook Deleter</a></li>
                        <li><a class="dropdown-item nav-link-new" href="https://speedtest.anditv.dev/">Speedtest</a></li>
                    </ul>
                </li>
            </ul>
        </header>
    ...
    <center>
        <div class="me-container"> <a href="https://anditv.dev/" aria-label="GitHub Link"><img class="avatar" src="../../assets/images/avatar.webp" alt="avatar" /></a>
        </div>
    </center>
    <center>
        <br>
