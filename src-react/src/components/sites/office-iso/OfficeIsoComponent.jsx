                        ...
                        <div>
                            ...
                            >
                                <option value="not-selected">
                                    Select an Office version
                                </option>
                                <option value="HomeStudent2019Retail">
                                    Office 2019 Home & Student
                                </option>
                                <option value="HomeBusiness2019Retail">
                                    Office 2019 Home & Business
                                </option>
                                <option value="Professional2019Retail">
                                    Office 2019 Professional
                                </option>
                                <option value="ProPlus2019Retail">
                                    Office 2019 Professional Plus
                                </option>
                                <option value="ProjectStd2019Retail">
                                    Project 2019 Standard
                                </option>
                                <option value="ProjectPro2019Retail">
                                    Project 2019 Professional
                                </option>
                                <option value="VisioStd2019Retail">
                                    Visio 2019 Standard
                                </option>
                                <option value="VisioPro2019Retail">
                                    Visio 2019 Professional
                                </option>
                                <option value="O365HomePremRetail">
                                    Office 365 Home Premium
                                </option>
                                <option value="O365BusinessRetail">
                                    Office 365 Business
                                </option>
                                <option value="O365ProPlusRetail">
                                    Office 365 Professional Plus
                                </option>
                            </select>
                        </div>
                        <div>
                            <b>Select Office Langauge:</b>
                            <br />
                            <select
                                id="language"
                                value={language}
